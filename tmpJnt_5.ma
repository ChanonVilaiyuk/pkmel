...
//Name: tmpJnt_3.ma
//Last modified: Sat, Dec 14, 2013 02:32:03 PM
//Codeset: 1252
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 512.0994887574434 150.27332931450758 285.94883314809096 ;
	setAttr ".r" -type "double3" -5.7383527299064028 55.00000000000005 -6.9314098346190729e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 579.80834814035325;
...
createNode joint -n "thumb1LFT_tmpJnt" -p "handLFT_tmpJnt";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jot" -type "string" "yxz";
	setAttr ".jo" -type "double3" 1.7315079359008285 0 0 ;
...
createNode joint -n "pinky1LFT_tmpJnt" -p "handLFT_tmpJnt";
	...
	setAttr ".r" -type "double3" -89.999999999969219 -80.961428166628821 89.999999999969603 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jot" -type "string" "yxz";
	setAttr ".jo" -type "double3" 1.7315079359008285 0 0 ;
...
createNode joint -n "thumb1RGT_tmpJnt" -p "handRGT_tmpJnt";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jot" -type "string" "yxz";
	setAttr ".jo" -type "double3" 1.7315079359005356 0 0 ;
	setAttr ".bps" -type "matrix" -0.59548586752167076 -0.80336578317847407 -4.9997343752636337e-014 0
		 0.73868319246536318 -0.54754062333671982 0.39312390790336815 0 -0.31582229615899904 0.23409973134130962 0.91948550452673483 0
		 11.518645340649305 21.905429719636764 0.32567524419271171 1;
	setAttr -k on -cb off ".radi" 0.5;
...
connectAttr "lowerTeeth_jnt.msg" ":hyperGraphLayout.hyp[10].dn";
connectAttr "upperTeeth_jnt.msg" ":hyperGraphLayout.hyp[11].dn";
connectAttr "tongue1_jnt.msg" ":hyperGraphLayout.hyp[12].dn";
connectAttr "thumbToe1LFT_jnt.msg" ":hyperGraphLayout.hyp[13].dn";
connectAttr "indexToe1LFT_jnt.msg" ":hyperGraphLayout.hyp[14].dn";
connectAttr "middleToe1LFT_jnt.msg" ":hyperGraphLayout.hyp[15].dn";
connectAttr "ringToe1LFT_jnt.msg" ":hyperGraphLayout.hyp[16].dn";
connectAttr "pinkyToe1LFT_jnt.msg" ":hyperGraphLayout.hyp[17].dn";
connectAttr "thumbToe1RGT_jnt.msg" ":hyperGraphLayout.hyp[18].dn";
connectAttr "indexToe1RGT_jnt.msg" ":hyperGraphLayout.hyp[19].dn";
connectAttr "middleToe1RGT_jnt.msg" ":hyperGraphLayout.hyp[20].dn";
connectAttr "ringToe1RGT_jnt.msg" ":hyperGraphLayout.hyp[21].dn";
connectAttr "pinkyToe1RGT_jnt.msg" ":hyperGraphLayout.hyp[22].dn";
// End of tmpJnt_3.ma
